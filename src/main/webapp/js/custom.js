...
$(function () {
	...
	$(document).ready(function() {
		// Only apply niceSelect to selects EXCEPT those that should be left untouched (e.g. #brandDrop, #modelDrop, #priceFilter)
		$('select').not('#brandDrop, #modelDrop, #priceFilter').niceSelect();

		$('[data-toggle="tooltip"]').not('#brandDrop, #modelDrop, #priceFilter').tooltip();
	});	
